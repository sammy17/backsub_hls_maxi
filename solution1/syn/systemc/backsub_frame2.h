...
#ifndef __backsub_frame2_H__
#define __backsub_frame2_H__
...
backsub_frame2_ram* meminst;


SC_CTOR(backsub_frame2) {
meminst = new backsub_frame2_ram("backsub_frame2_ram");
