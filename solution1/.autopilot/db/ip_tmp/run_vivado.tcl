...
source "/home/chathura/HoG_IP/backsub_hls_maxi/solution1/syn/verilog/backsub_ap_fadd_3_full_dsp_32_ip.tcl"
if {[regexp -nocase {2015\.3.*} $vivado_ver match] || [regexp -nocase {2016\.1.*} $vivado_ver match]} {
    extract_files -base_dir "./prjsrcs/sources_1/ip" [get_files -all -of [get_ips backsub_ap_fadd_3_full_dsp_32]]
}
source "/home/chathura/HoG_IP/backsub_hls_maxi/solution1/syn/verilog/backsub_ap_fmul_2_max_dsp_32_ip.tcl"
if {[regexp -nocase {2015\.3.*} $vivado_ver match] || [regexp -nocase {2016\.1.*} $vivado_ver match]} {
    extract_files -base_dir "./prjsrcs/sources_1/ip" [get_files -all -of [get_ips backsub_ap_fmul_2_max_dsp_32]]
}
source "/home/chathura/HoG_IP/backsub_hls_maxi/solution1/syn/verilog/backsub_ap_sitofp_4_no_dsp_32_ip.tcl"
if {[regexp -nocase {2015\.3.*} $vivado_ver match] || [regexp -nocase {2016\.1.*} $vivado_ver match]} {
