set C_TypeInfoList {{ 
"backsub" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"frame_in": [[],{ "pointer": "0"}] }, {"frame_out": [[],{ "pointer": "0"}] }, {"init": [[], {"scalar": "bool"}] }],[],""], 
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "frame_in","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"offset": { "type": "dynamic","port_name": "frame_in","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 103679,"step" : 1}]},{"cName": "frame_out","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"offset": { "type": "dynamic","port_name": "frame_out","bundle": "AXILiteS"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 103679,"step" : 1}]}]}]} , 
