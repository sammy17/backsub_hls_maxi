...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 frame_in W 0x0 "Data signal of frame_in" {{0 32 frame_in W 0 "Bit 31 to 0 Data signal of frame_in"}}} {0x18 frame_out W 0x0 "Data signal of frame_out" {{0 32 frame_out W 0 "Bit 31 to 0 Data signal of frame_out"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS s_axi_CRTL_BUS m_axi_gmem"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 230419 II x}
...
set enable_xo_gen 0
set kernel_files {/home/zynq-fyp/Desktop/maxi_latest/backsub_hls_maxi/core.cpp}
if {$enable_xo_gen} {
